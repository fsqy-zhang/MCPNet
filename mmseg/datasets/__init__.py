...
from .deepglobe_patch import deepglobe_patch
from .uav_patch import UVA_dataset_patch
from .uav import UVA_dataset
# yapf: disable
...
__all__ = [
    ...
    'NYUDataset','DeepGlobeDataset','AerialDataset','deepglobe_patch',
    'UVA_dataset_patch','UVA_dataset'
]
